import { readContactPage } from "@/services/contact_us";
      ...
      <div className="max-w-6xl mx-auto w-full">
        <div className="flex flex-col lg:flex-row items-start gap-14 lg:gap-16">
          ...
          <div className="flex-1 flex flex-col gap-6 max-w-xl w-full">
                ...
                const inner = (
                  ...
                  >
                    ...
                    {card.href && (
                      <IconRenderer
                        name="ExternalLink"
                        className="w-3.5 h-3.5 text-gray-300 ml-auto mt-0.5 shrink-0 transition-colors duration-300 group-hover:text-[#0a2240]"
                        aria-hidden="true"
                      />
                    )}
                  </div>
            ...
            >
              <div
                className="w-10 h-10 rounded-xl bg-[#0a2240] flex items-center justify-center shrink-0"
                aria-hidden="true"
              >
                <IconRenderer
              ...
              <div>
                <p className="text-[#0a2240] text-sm font-bold leading-tight mb-1 font-serif">
                  {businessHours.title}
                </p>
              ...
              {socialLinks.map((social) => {
                return (
                  <a
                    ...
                    className="w-10 h-10 rounded-xl bg-[#0a2240]/10 text-[#0a2240] flex items-center justify-center transition-all duration-300 hover:bg-[#0a2240] hover:text-white hover:-translate-y-0.5 hover:shadow-md no-underline"
                  >
          ...
          <div className="flex-1 flex flex-col w-full max-w-lg">
            ...
            <div className="mt-6 grid grid-cols-1 gap-4 w-full max-w-115 mx-auto">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl font-semibold text-base transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 no-underline bg-[#0a2240] text-white border-2 border-[#0a2240] hover:bg-[#0e2f5a]"
