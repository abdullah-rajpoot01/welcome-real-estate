import { readCtaSection } from "@/services/basic/cta";
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="relative bg-primary rounded-2xl px-8 py-16 flex flex-col items-center text-center gap-6 overflow-hidden">
          ...
          {/* Gold divider top */}
          <div 
            className="w-16 h-0.5 bg-tertiary rounded-full" 
            aria-hidden="true"
          />
          ...
          <Link
            href={cta.link}
            className="group relative inline-flex items-center gap-2.5 px-8 py-4 rounded-xl font-semibold text-base bg-tertiary text-primary no-underline transition-all duration-300 hover:bg-tertiary-alternative hover:shadow-lg hover:shadow-black/20 hover:-translate-y-0.5 active:translate-y-0 mt-2"
