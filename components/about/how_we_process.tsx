...
import { readProcessSection } from "@/services/about/process";
          ...
          {steps && steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className="absolute top-3 right-4 text-6xl font-bold text-primary/5 font-serif select-none pointer-events-none leading-none"
                  aria-hidden="true"
                >
                  {stepNumber}
                </span>
                ...
                {/* Content */}
                <div>
                  <p className="text-primary text-sm font-bold leading-tight mb-1.5 font-serif">
                    {step.title}
                  </p>
                ...
                {index < steps.length - 1 && (
                  <div
                    className="hidden lg:block absolute -right-3 top-1/2 -translate-y-1/2 w-6 h-0.5 bg-primary/15 z-10"
                    aria-hidden="true"
                  />
                )}
              </div>
