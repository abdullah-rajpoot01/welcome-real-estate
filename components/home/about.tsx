      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-10 ">
          ...
          <div className="flex-1 flex flex-col gap-6 max-w-xl">
            ...
            <Link
              href={cta.link}
              className="group inline-flex items-center gap-2.5 self-start px-6 py-3.5 rounded-xl font-semibold text-base bg-primary text-white border-2 border-primary no-underline transition-all duration-300 hover:bg-secondary hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-0.5 active:translate-y-0"
