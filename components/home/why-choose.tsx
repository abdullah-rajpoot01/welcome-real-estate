...
import { readWhyChooseUsSection } from "@/services/home/wh_choose_us";
        ...
        <div className="flex flex-col lg:flex-row gap-14 lg:gap-24 items-start">
          ...
          <div className="flex-1 flex flex-col gap-6 max-w-sm">
            ...
            <div>
              ...
              <div 
                className="w-16 h-0.5 bg-tertiary mb-5 rounded-full" 
                aria-hidden="true"
              />
              ...
              return (
                ...
                >
                  ...
                  <div 
                    ...
                    aria-hidden="true"
                  >
                    <span className="text-xs font-semibold text-tertiary/60 tabular-nums">
                      {String(index + 1).padStart(2, "0")}
                    </span>
                    <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center transition-all duration-300 group-hover:bg-tertiary group-hover:scale-110">
                      <IconRenderer 
                        name={point.icon} 
                  ...
                  <div className="flex flex-col gap-1 pt-1">
                    <h3 className="text-base font-semibold text-white transition-colors duration-300 group-hover:text-tertiary">
                      {point.title}
                    </h3>
